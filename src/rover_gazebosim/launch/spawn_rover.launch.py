...
def generate_launch_description():
    ...
    ekf_file = os.path.join(get_package_share_directory('rover_gazebosim'), 'config', 'ekf.yaml')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                "gz_args": "~/mrt_ws/src/rover_gazebosim/worlds/basic_map.sdf"
            }.items(),
        ),
        ...
        Node(
            ...
            output='screen',
            parameters=[os.path.join(get_package_share_directory("rover_gazebosim"), 'config', 'ekf.yaml')],
           ),
